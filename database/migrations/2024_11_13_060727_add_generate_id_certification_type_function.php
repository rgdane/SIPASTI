...
class AddGenerateIdCertificationTypeFunction extends Migration
{
    public function up()
    {
        DB::unprepared('
            DROP FUNCTION IF EXISTS generate_id_certification_type;
            CREATE DEFINER = `root`@`localhost` FUNCTION `generate_id_certification_type`()
    ...
    {
        DB::unprepared('DROP FUNCTION IF EXISTS generate_id_certification_type');
    }
}
