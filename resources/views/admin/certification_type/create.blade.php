<form action="{{ url('/certification_type/store') }}" method="POST" id="form-tambah">
    @csrf
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Data Jenis Sertifikasi</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <!-- Kode Jenis Sertifikasi -->
                <div class="form-group">
                    <label for="certification_type_code">Kode Jenis Sertifikasi</label>
                    <input value="" type="text" name="certification_type_code" id="certification_type_code" class="form-control" required>
                ...
                <div class="form-group">
                    ...
                    <input value="" type="text" name="certification_type_name" id="certification_type_name" class="form-control" required>
