<form action="{{ url('/certification_type/import_excel') }}" method="POST" id="form-import">
    @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ asset('template_jenis_sertifikasi.xlsx') }}" class="btn btn-info btn-sm" download><i
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="file_certification_type" id="file_certification_type" class="form-control" required>
                    <small id="error-file_certification_type" class="error-text form-text text-danger"></small>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        $("#form-import").validate({
            rules: {
                file_certification_type: {  // Mengubah dari file_level ke file_certification_type
                    required: true,
                    extension: "xlsx"
                }
            },
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status) { // Jika sukses
                            ...
                            dataCertificationType.ajax.reload(); // Reload DataTables
