<form action="{{ url('/course/import_excel') }}" method="POST" id="form-import">
    @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ asset('template_mata_kuliah.xlsx') }}" class="btn btn-info btn-sm" download><i
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="file_course" id="file_course" class="form-control" required>
                    <small id="error-file_course" class="error-text form-text text-danger"></small>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        $("#form-import").validate({
            rules: {
                file_course: {  // Mengubah dari file_level ke file_course
                    required: true,
                    extension: "xlsx"
                }
            },
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status) { // Jika sukses
                            ...
                            dataCourse.ajax.reload(); // Reload DataTables
