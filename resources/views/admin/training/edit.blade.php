...
<form action="{{ url('/training/' . $training->training_id . '/update') }}" method="POST" id="form-tambah"
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <select name="training_vendor_id" id="training_vendor_id" class="form-control" required>
                        ...
                        <option value="{{ $l->training_vendor_id }}" {{ $l->training_vendor_id ==
                            $training->training_vendor_id ? 'selected' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <input value="{{ old('training_name', $training->training_name) }}" type="text" name="training_name"
                        id="training_name" class="form-control" required>
                ...
                <div class="form-group">
                    ...
                    <input value="{{ old('training_hours', $training->training_hours) }}" type="number"
                        name="training_hours" id="training_hours" class="form-control" required>
                ...
                <div class="form-group">
                    ...
                    <input value="{{ old('training_location', $training->training_location) }}" type="text"
                        name="training_location" id="training_location" class="form-control" required>
                ...
                <div class="form-group">
                    ...
                    <input value="{{ old('training_cost', $training->training_cost) }}" type="number"
                        name="training_cost" id="training_cost" class="form-control" required>
                ...
                <div class="form-group">
                    ...
                    <input value="{{ old('training_quota', $training->training_quota) }}" type="number"
                        name="training_quota" id="training_quota" class="form-control" required>
                ...
                <div class="form-group">
                    ...
                    <select name="course_id[]" id="course_id" class="form-control" multiple required>
                        @foreach($course as $l)
                        <option value="{{ $l->course_id }}" @foreach ($courseTraining as $t) {{$l->course_id ==
                            $t->course_id ? 'selected' : ''}}
                            @endforeach >
                ...
                <div class="form-group">
                    ...
                    <select name="interest_id[]" id="interest_id" class="form-control" multiple required>
                        ...
                        <option value="{{ $l->interest_id }}" @foreach ($interestTraining as $t) {{$l->interest_id ==
                            $t->interest_id ? 'selected' : ''}}
                            @endforeach >
                            {{ $l->interest_name }}
                        </option>
                        @endforeach
