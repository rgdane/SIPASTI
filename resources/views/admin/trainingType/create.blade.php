<form action="{{ url('/trainingType/ajax') }}" method="POST" id="form-tambah">
    @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input value="" type="text" name="training_type_code" id="training_type_code" class="form-control" required>
                ...
                <div class="form-group">
                    ...
                    <input value="" type="text" name="training_type_name" id="training_type_name" class="form-control" required>
