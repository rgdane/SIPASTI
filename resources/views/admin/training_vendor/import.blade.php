<form action="{{ url('/training_vendor/import_excel') }}" method="POST" id="form-import">
    @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ asset('template_vendor_pelatihan.xlsx') }}" class="btn btn-info btn-sm" download><i
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="file_training_vendor" id="file_training_vendor" class="form-control" required>
                    <small id="error-file_training_vendor" class="error-text form-text text-danger"></small>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        $("#form-import").validate({
            rules: {
                file_training_vendor: {  // Mengubah dari file_level ke file_training_vendor
                    required: true,
                    extension: "xlsx"
                }
            },
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status) { // Jika sukses
                            ...
                            dataTrainingVendor.ajax.reload(); // Reload DataTables
