...
<div id="modal-master" class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <a href="{{ url('/certification_head') }}" class="btn btn-warning">Kembali</a>
        </div>
    </div>
</div>
@else
                ...
                <table class="table table-sm table-bordered table-striped table-rounded">
                    ...
                    <tr>
                        ...
                        <td class="col-9">
                            ...
                            <br>
                            <button type="button" onclick="window.open('{{ url('/certification_head/' . $certification->certification_id . '/file') }}', '_blank')" class="btn btn-info btn-sm">Lihat Dokumen</button>
                        </td>
                    </tr>
                    <tr>
