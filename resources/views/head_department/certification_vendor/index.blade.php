...
<div class="card card-outline card-primary">
    <div class="card-header">
        ...
        <div class="card-tools">
            ...
            <a href="{{ url('/certification_vendor_head/export_excel') }}" class="btn btn-primary">
                <i class="bi bi-file-earmark-excel"></i> Export XLSX</a>
            <a href="{{ url('/certification_vendor_head/export_pdf') }}" class="btn btn-warning">
...
<script>
    ...
    $(document).ready(function() {
        dataCertificationVendor = $('#table_certification_vendor').DataTable({
            ...
            info: false,
            ajax: {
                url: "{{ url('certification_vendor_head/list') }}",
                dataType: "json",
                type: "POST",
                data: function(d) {
